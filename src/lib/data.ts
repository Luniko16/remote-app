...
export const resume = {
  ...
  certificates: [
    ...
    },
    {
      ...
      issuer: 'Coursera',
      date: '2025',
      url: '/api/certificate?file=Generative AI with Large Language Models.pdf',
    ...
    },
    {
      ...
      issuer: 'Coursera',
      date: '2025',
      url: '/api/certificate?file=AI Essentials.pdf',
    ...
    },
    {
      ...
      issuer: 'Coursera',
      date: '2025',
      url: '/api/certificate?file=Python for Data Science, AI & Development.pdf',
